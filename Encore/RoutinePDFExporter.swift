...
final class RoutinePDFExporter {
    static func renderPDF(for routine: Routine) -> Data {
        ...
        let pdfData = renderer.pdfData { context in
            ...
            let subtitleStr = "TANEC: \(routine.danceName.uppercased()) • KATEGÓRIA: \(routine.danceCategory.uppercased()) • ENCORE"
            ...
            let footerText = "Vygenerované aplikáciou Encore • Oficiálny súťažný hárok choreografie"
            ...
            if let qr = generateQRCode(from: "encore://routine/\(routine.id.uuidString)") {
